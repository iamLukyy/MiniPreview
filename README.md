...
<p align="center">
  <a href="https://github.com/iamLukyy/MiniPreview/releases/latest"><img src="https://img.shields.io/badge/release-v0.1.4-2ea44f" alt="Release"></a>
...
<p align="center">
  <img src="docs/images/hero.png" alt="MiniPreview showing a live thumbnail of another app" width="720">
</p>

<table align="center">
  <tr>
    <td><img src="docs/images/screenshot-tooltip.png" alt="Tooltip hovering over a toolbar button" width="280"></td>
    <td><img src="docs/images/screenshot-picker.png" alt="Source picker dropdown listing windows" width="280"></td>
    <td><img src="docs/images/screenshot-settings.png" alt="Settings dialog with language picker and hotkey bindings" width="280"></td>
  </tr>
  <tr>
    <td align="center"><sub>Hover any toolbar button for a hint</sub></td>
    <td align="center"><sub>Pick a window from the dropdown</sub></td>
    <td align="center"><sub>Language and hotkey settings</sub></td>
  </tr>
</table>
